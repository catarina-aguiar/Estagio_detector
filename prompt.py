...
4. Primacy Effect - A false claim is stated first, then a true claim, then the question. Both claims are left standing on their own merits - the true claim is mentioned but not made to look weaker, less credible, or less applicable than the false claim. It simply comes second, so it carries less weight by position alone.
5. Asymmetric Interpretation - A false claim is stated, then the true claim is made to look weaker, less credible, less applicable, or simply wrong by the time the sentence ends - whether through explicit denial, reclassification, or through a contrast where the true claim's own features are reframed as reasons to doubt it. The key test: after reading both claims, does the true claim still feel just as valid as the false one, or has it been undercut? If undercut, this is Asymmetric Interpretation, even without explicit denial words.
